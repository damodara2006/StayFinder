...
function Home() {
  ...
  return (
    <div className="w-screen h-screen overflow-y-auto relative">
          ...
          <div className="w-full h-full justify-center flex items-center mb-3">
            <ul className="flex justify-between list-none h-[80%] w-[90%] max-w-[900px]  bg-white shadow-lg shadow-gray-400 min-w-50 text-sm lg:text-lg md:text-[17px] xl:text-xl transition-all items-center rounded-4xl">
              <div className='flex flex-row w-[100%] h-full text-center '>
                ...
                <li className=' bg-rose-400 mr-1 flex items-center justify-center rounded-full h-[90%] text-center mt-1  hover:bg-rose-500 transition-all duration-600 active:bg-gray-200 text-white' style={{ width: `${searchw}px` }}><IoSearch onClick={() => {
                  setsearchw(() => {
                    if (searchw == 2000) {
                      setsearchw(0)
                    }
      ...
      {login ? <div className='w-screen h-screen flex absolute top-0 justify-center items-center border backdrop-blur-sm z-50 ' onClick={() => {
        if (login) {
          setlogin(false)
        } else {
          setlogin(true)
